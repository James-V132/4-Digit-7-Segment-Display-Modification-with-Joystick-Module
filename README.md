# 4-Digit-7-Segment-Display-Modification-with-Joystick-Module
### Using a Joystick Module to change the numbers displayed on a 5461AS 7-Segment Display
+ Pushing the joystick rightward moves the decimal point highlighted to the right and vice versa for pushing the joystick leftward
